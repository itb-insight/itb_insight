...
const timelineItems = [
  { title: "Registration", date: "20 Agustus - 18 September 2026", side: "right" },
  { title: "Pre-Elim: Case Release", date: "25 September 2026", side: "left" },
  { title: "Pengumpulan Pre-Elim: BMC", date: "8 Oktober 2026", side: "right" },
  { title: "Semifinal", date: "15-29 Oktober 2026", side: "left" },
  { title: "Final", date: "5-22 November 2026", side: "right" },
  { title: "Pitching", date: "26 November 2026", side: "left" },
  { title: "Awarding", date: "26 November 2026", side: "right" },
] as const;
    ...
    >
      ...
      >
        ...
        >
          ...
          <h1
            style={{
              backgroundImage: `linear-gradient(180deg, #DEE8FB 0%, #6CCB59 100%)`,
              WebkitBackgroundClip: "text",
              backgroundClip: "text",
              WebkitTextFillColor: "transparent",
              color: "transparent",
          ...
          <p
            style={{
              ...
              color: colors.bodyText,
              margin: 0,
              maxWidth: "100%", // <-- Ubah maxWidth menjadi 100% atau hapus baris ini
            }}
          >
            Business Plan Competition (BPC) ITB INSIGHT 2026 merupakan kompetisi nasional di bidang inovasi bisnis yang mengangkat<br />
            tema pengaplikasian Artificial Intelligence (AI) yang ditujukan bagi mahasiswa (D3/D4/S1) dan siswa SMA/SMK/MA sederajat.<br />
            Kompetisi ini dirancang sebagai wadah pengembangan generasi muda dalam menciptakan solusi bisnis yang inovatif, adaptif, dan<br />
          ...
          <div style={{ position: "relative", minHeight: fluid(770), zIndex: 1 }}>
            <div
              style={{
                ...
                background: "linear-gradient(180deg, #DEE8FB 0%, #6CCB59 100%)",
                border: "4px solid",
                borderImageSource: "linear-gradient(180deg, #DEE8FB 0%, #6CCB59 100%)",
                borderImageSlice: 1,
              }}
            />
                ...
                <React.Fragment key={item.title}>
                  <div
                    style={{
                      ...
                      borderImageSource: "linear-gradient(180deg, #DEE8FB 0%, #6CCB59 100%)",
                      borderImageSlice: 1,
                      boxShadow: `0 0 ${fluid(12)} rgba(108,203,89,0.8)`,
                    }}
                  />
                  <div
                    style={{
