...
const gradientTextPink: React.CSSProperties = {
  backgroundImage: `linear-gradient(180deg, ${colors.ice100} 0%, ${colors.pink200} 100%)`,
  WebkitBackgroundClip: "text",
  backgroundClip: "text",
  WebkitTextFillColor: "transparent",
  color: "transparent",
...
const timelineItems = [
  { title: "Pendaftaran", date: "14 Agustus - 6 September 2026", side: "right" },
  { title: "Pengumuman Penyisihan", date: "19 Oktober 2026", side: "left" },
  { title: "Technical Meeting", date: "14 November 2026", side: "right" },
  { title: "Semifinal", date: "27 November 2026", side: "left" },
  { title: "Final", date: "28 November 2026", side: "right" },
  { title: "Awarding", date: "28 November 2026", side: "left" },
] as const;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Lomba robot Search and Rescue (SAR) ITB Insight 2026 adalah ajang
            kompetisi nasional bagi mahasiswa/i di Indonesia yang bertujuan
            mengembangkan kreativitas dalam menjawab permasalahan dunia nyata
            yang membutuhkan solusi berbasis teknologi. Kompetisi ini
            dilaksanakan melalui tiga tahap, yaitu tahap pendaftaran, tahap
            implementasi, dan tahap final.
          </p>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <section style={{ position: "relative", zIndex: 1, padding: `${fluid(48)} ${fluid(64)}` }}>
          ...
          <div style={{ position: "relative", minHeight: fluid(650), zIndex: 1 }}>
            <div
              style={{
                position: "absolute",
                left: "50%",
                ...
                backgroundImage: `linear-gradient(180deg, ${colors.pink100} 0%, ${colors.pink200} 100%)`,
              }}
            />
                ...
                <React.Fragment key={item.title}>
                  <div
                    style={{
                      ...
                      transform: "translate(-50%, -50%)",
                      backgroundImage: `linear-gradient(180deg, ${colors.pink100} 0%, ${colors.pink200} 100%)`,
                      boxShadow: `0 0 ${fluid(12)} rgba(255,170,170,0.8)`,
                    }}
                  />
                  <div
                    style={{
