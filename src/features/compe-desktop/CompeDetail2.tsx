...
const timelineItems = [
  { title: "Pendaftaran", date: "14 Agustus - 20 November 2026", side: "right" },
  { title: "Technical Meeting", date: "21 November 2026", side: "left" },
  { title: "Penyisihan", date: "2026", side: "right" },
  { title: "Pengumuman Penyisihan", date: "2026", side: "left" },
  { title: "Semifinal", date: "27 November 2026", side: "right" },
  { title: "Final", date: "28 November 2026", side: "left" },
  { title: "Awarding", date: "2026", side: "right" },
] as const;
    ...
    >
      ...
      >
        ...
        >
          ...
          <h1
            style={{
              backgroundImage: `linear-gradient(180deg, #ACC7FF 0%, #C08CFF 100%)`,
              WebkitBackgroundClip: "text",
              backgroundClip: "text",
              WebkitTextFillColor: "transparent",
              color: "transparent",
...
<p
          ...
          >
            Lomba Drone Obstacle adalah ajang kompetisi nasional bagi mahasiswa/i Indonesia yang bertujuan mengembangkan kreativitas<br />
            dalam menjawab permasalahan dunia nyata yang membutuhkan solusi berbasis teknologi. Kompetisi ini dilaksanakan selama dua<br />
          ...
          <div style={{ position: "relative", minHeight: fluid(770), zIndex: 1 }}>
            <div
              style={{
                ...
                background: "linear-gradient(180deg, #C08CFF 0%, #E9DBF9 100%)",
                border: "4px solid",
                borderImageSource: "linear-gradient(180deg, #C08CFF 0%, #E9DBF9 100%)",
                borderImageSlice: 1,
              }}
            />
